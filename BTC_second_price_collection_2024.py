...
dates = pd.date_range(start="2025-09-01", end='2025-11-23', freq='D')
...
for i,t in enumerate(tqdm(date_strings)):
    if i==0:
        ...
        p = fetch_binance_ohlcv("BTCUSDT", interval, start_time, end_time)
...
price_data.to_csv('bitcoin_second_price2025.csv')
